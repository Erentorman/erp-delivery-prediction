...
internal sealed record MockErpWorkOrder(string WorkOrderReference, string? OrderReference, string ProductReference, string Status, IReadOnlyList<MockErpWorkOrderOperation> Operations, string? RoutingReference);
